...
### 1. 🔴 Crawler returned unparseable data: I encountered an error while trying to fetch the page and get a DOM snapshot: "MCP to
...
|---|---|---|---|---|
| 1 | 🔴 Critical | N/A | Crawler returned unparseable data: I encountered an error while trying to fetch… | `document` |
...
| Field | Value |
|---|---|
| Audit started | 2026-06-24 19:44 UTC |
| Pages audited | 1 |
| Total findings | 1 |
